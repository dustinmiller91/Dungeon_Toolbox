...
public class LocationNameGenerator {
  ...
  Random r = new Random();
  // This will be used for the "Language influences". This can later be paramaterized in a constructor.
...
// Make the actual title
  public String townNameGen() { // HashSet<String> nameSet) {
  ...
  public String locationNameGen(HashSet<String> nameSet) {
    return "";
  }
  
  // 
  public HashSet<String> getNameSet(String nameRace) {
    // If no nameset is found the returned nameset simply says "ERROR"
    HashSet<String> nameSet = new HashSet<String>(Arrays.asList("ERROR"));
    // Gets a random nameset based on String input for race
    switch(nameRace) {    
      case "Dragonborn":
        switch(r.nextInt(3)) {
          case 0:
            nameSet = charNameGen.dragonbornNamesMale_XGE;
            break;
          case 1:
            nameSet = charNameGen.dragonbornNamesFemale_XGE;
            break;
          case 2:
            nameSet = charNameGen.dragonbornNamesFamily_XGE;
        }
        break;
      case "Dwarf":
        switch(r.nextInt(3)) {
          case 0:
            nameSet = charNameGen.dwarfNamesMale_XGE;
            break;
          case 1:
            nameSet = charNameGen.dwarfNamesFemale_XGE;
            break;
          case 2:
            nameSet = charNameGen.dwarfNamesFamily_XGE;
        }
        break;
      case "Elf":
        switch(r.nextInt(3)) {
          case 0:
            nameSet = charNameGen.elfNamesMale_XGE;
            break;
          case 1:
            nameSet = charNameGen.elfNamesFemale_XGE;
            break;
          case 2:
            nameSet = charNameGen.elfNamesFamily_XGE;
        }
        break;
      case "Gnome":
        switch(r.nextInt(3)) {
          case 0:
            nameSet = charNameGen.gnomeNamesMale_XGE;
            break;
          case 1:
            nameSet = charNameGen.gnomeNamesFemale_XGE;
            break;
          case 2:
            nameSet = charNameGen.gnomeNamesFamily_XGE;
        }
        break;
      case "Halfling":
        switch(r.nextInt(3)) {
          case 0:
            nameSet = charNameGen.halflingNamesMale_XGE;
            break;
          case 1:
            nameSet = charNameGen.halflingNamesFemale_XGE;
            break;
          case 2:
            nameSet = charNameGen.halflingNamesFamily_XGE;
        }
        break;
      case "Orc":
        switch(r.nextInt(3)) {
      ...
      case "Tiefling":
        switch(r.nextInt(3)) {
          case 0:
            nameSet = charNameGen.tieflingNamesMale_XGE;
            break;
          case 1:
            nameSet = charNameGen.tieflingNamesFemale_XGE;
            break;
          case 2:
            nameSet = charNameGen.tieflingNamesVirtue_XGE;
      }
    }
    return nameSet;
  }
  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < 20; i++) {
      System.out.println(locNameGen.townNameGen()); // locNameGen.getNameSet("Orc")));
    }
  }
}